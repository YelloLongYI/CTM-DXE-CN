...
chat_firelands["stumbles as his armor is shattered"] = "stolpert, als seine Rüstung zerstört wird"
...
npc_firelands["Crystal Prison"] = "Kristallgefängnis"
npc_firelands["Crystal Prison Trap"] = "Kristallgefängnisfalle"
...
npc_firelands["Riplimb"] = "Wadenbeißer"
...
chat_firelands["Aha! The interlopers"] = "¡Ajá! ¡Los intrusos!"
chat_firelands["^Enough"] = "^¡Basta!"
chat_firelands["^Fall to your knees"] = "^¡De rodillas, mortales!"
chat_firelands["^Fire..."] = "^Fuego..."
chat_firelands["^Hah? Hruumph?"] = "^¿Eh? ¿Blandos seres de carne?"
chat_firelands["^I serve a new master now"] = "^¡Mortales, ahora sirvo a un nuevo amo!"
-- chat_firelands["^No, fiend"] = ""
chat_firelands["^Reborn in flame"] = "^¡Renazco en la llama!"
chat_firelands["^Spiderlings have been roused from their nest"] = "^¡Las arañitas emergen de su nido!"
chat_firelands["^Sulfuras will be your end"] = "^Sulfuras será vuestro fin"
chat_firelands["^The Molten Eggs begin to hatch"] = "^¡Los huevos de magma empiezan a" -- Needs review
chat_firelands["^These skies are MINE!"] = "^¡Estos cielos son MÍOS!"
...
npc_firelands["Beth'tilac"] = "Beth'tilac"
npc_firelands["Cinderweb Drone"] = "Zángano Telaceniza"
npc_firelands["Cinderweb Spiderling"] = "Arañita Telaceniza"
npc_firelands["Cinderweb Spinner"] = "Hiladora Telaceniza"
npc_firelands["Crystal Prison"] = "Prisión de cristal"
npc_firelands["Crystal Prison Trap"] = "Trampa de prisión de cristal"
npc_firelands["Immolation Trap"] = "Trampa de inmolación"
...
chat_firelands["Aha! The interlopers"] = "^Ah ah ! Les intrus"
chat_firelands["^Enough"] = "^Assez" -- Needs review
chat_firelands["^Fall to your knees"] = "^À genoux, mortels"
chat_firelands["^Fire..."] = "^Du feu"
chat_firelands["^Hah? Hruumph?"] = "^Hein ? Humph ?"
chat_firelands["^I serve a new master now"] = "^Je sers désormais un nouveau maître"
chat_firelands["^No, fiend"] = "^Non, monstre" -- Needs review
chat_firelands["^Reborn in flame"] = "^Renaissance de flammes"
chat_firelands["^Spiderlings have been roused from their nest"] = "^De jeunes araignées sont sorties de leur nid"
chat_firelands["^Sulfuras will be your end"] = "^Sulfuras sera votre fin"
chat_firelands["^The Molten Eggs begin to hatch"] = "^Les œufs en fusion sont en train d'éclore"
chat_firelands["^These skies are MINE!"] = "^Ce ciel est à MOI"
chat_firelands["^Too soon!"] = "^Trop tôt !"
chat_firelands["stumbles as his armor is shattered"] = "trébuche quand son armure est brisée"
...
npc_firelands["Baleroc"] = "Baleroc"
npc_firelands["Beth'tilac"] = "Beth'tilac"
npc_firelands["Cinderweb Drone"] = "Ouvrière braisetoile"
npc_firelands["Cinderweb Spiderling"] = "Jeune araignée braisetoile"
npc_firelands["Cinderweb Spinner"] = "Tisseuse braisetoile"
npc_firelands["Crystal Prison"] = "Prison de cristal"
npc_firelands["Crystal Prison Trap"] = "Piège de prison de cristal"
npc_firelands["Immolation Trap"] = "Piège d'immolation"
...
npc_firelands["Alysrazor"] = "艾里絲拉卓"
npc_firelands["Baleroc"] = "巴勒羅克"
npc_firelands["Beth'tilac"] = "貝絲堤拉克"
-- npc_firelands["Cinderweb Drone"] = ""
-- npc_firelands["Cinderweb Spiderling"] = ""
-- npc_firelands["Cinderweb Spinner"] = ""
-- npc_firelands["Crystal Prison"] = ""
