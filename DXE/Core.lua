...
local defaults = {
    ...
    profile = {
        ...
        CustomSounds = {
            aeblood = "aeblood",
            aesoon = "aesoon",
            avoidslime = "avoidslime",
            awaycloud = "awaycloud",
            awayfireorb = "awayfireorb",
            awayflower = "awayflower",
            awayline = "awayline",
            awaymutant = "awaymutant",
            awayshard = "awayshard",
            awayspider = "awayspider",
            backsoon = "backsoon",
            balancenow = "balancenow",
            bbappear = "bbappear",
            bigkill = "bigkill",
            blackorb = "blackorb",
            blisterling = "blisterling",
            bluecircle = "bluecircle",
            bluecircleboom = "bluecircleboom",
            blueessence = "blueessence",
            boltappear = "boltappear",
            boomrun = "boomrun",
            catalysm = "catalysm",
            changemt = "changemt",
            checkhp = "checkhp",
            chickenfrenzy = "chickenfrenzy",
            clickbravo = "clickbravo",
            ...
            counttwo = "counttwo",
            crystalappear = "crystalappear",
            dangsoon = "dangsoon",
            debuffhigh = "debuffhigh",
            deciblade = "deciblade",
            deepsoon = "deepsoon",
            dispelnow = "dispelnow",
            dragonnow = "dragonnow",
            ...
            eggsoon = "eggsoon",
            elementsoon = "elementsoon",
            empowersulf = "empowersulf",
            empowersulfsoon = "empowersulfsoon",
            fiend = "fiend",
            findmc = "findmc",
            findwell = "findwell",
            findwind = "findwind",
            firearound = "firearound",
            firebreathsoon = "firebreathsoon",
            firecircle = "firecircle",
            firecirclesoon = "firecirclesoon",
            fireline = "fireline",
            firestorm = "firestorm",
            firestormsoon = "firestormsoon",
            firewall = "firewall",
            flamemelee = "flamemelee",
            flamemiddle = "flamemiddle",
            flamerange = "flamerange",
            flamerepeat = "flamerepeat",
            flamesoon = "flamesoon",
            followline = "followline",
            fragsoon = "fragsoon",
            frostflake = "frostflake",
            ghostsoon = "ghostsoon",
            goblinappear = "goblinappear",
            gofirecircle = "gofirecircle",
            greenessence = "greenessence",
            gripaway = "gripaway",
            hammerleft = "hammerleft",
            hammermiddle = "hammermiddle",
            hammerright = "hammerright",
            healparasite = "healparasite",
            heartice = "heartice",
            helpkick = "helpkick",
            holdit = "holdit",
            iceball = "iceball",
            icetombsoon = "icetombsoon",
            ...
            killegg = "killegg",
            killfireele = "killfireele",
            killghost = "killghost",
            killgreen = "killgreen",
            killicetomb = "killicetomb",
            killmeteor = "killmeteor",
            killmixone = "killmixone",
            killmuscle = "killmuscle",
            killparasite = "killparasite",
            killpurple = "killpurple",
            killshaele = "killshaele",
            killshield = "killshield",
            killslime = "killslime",
            killvoid = "killvoid",
            killyellow = "killyellow",
            lavaspew = "lavaspew",
            leftside = "leftside",
            masteraura = "masteraura",
            meteorrun = "meteorrun",
            meteorsoon = "meteorsoon",
            meteoryou = "meteoryou",
            mobsoon = "mobsoon",
            nefsoon = "nefsoon",
            orbrun = "orbrun",
            pillar = "pillar",
            poisoncircle = "poisoncircle",
            ptwo = "ptwo",
            purplecirclesoon = "purplecirclesoon",
            redessence = "redessence",
            rightside = "rightside",
            roarsoon = "roarsoon",
            rootnow = "rootnow",
            runaway = "runaway",
            ...
            shadow3ae = "shadow3ae",
            shard = "shard",
            shattericesoon = "shattericesoon",
            shieldoff = "shieldoff",
            shieldsoon = "shieldsoon",
            shrapnelyou = "shrapnelyou",
            shroud = "shroud",
            skinsoon = "skinsoon",
            someonecaught = "someonecaught",
            sonicsoon = "sonicsoon",
            sparksoon = "sparksoon",
            spear = "spear",
            specialsoon = "specialsoon",
            spiderling = "spiderling",
            spinner = "spinner",
            spread = "spread",
            squall = "squall",
            stackpurple = "stackpurple",
            staticout = "staticout",
            stilldanger = "stilldanger",
            stompsoon = "stompsoon",
            stompstart = "stompstart",
            stopatk = "stopatk",
            stopmove = "stopmove",
            stormpillar = "stormpillar",
            stunsoon = "stunsoon",
            telesoon = "telesoon",
            ...
            twkill = "twkill",
            volcano = "volcano",
            watchimpale = "watchimpale",
            watchwave = "watchwave",
            wavesoon = "wavesoon",

            attackarcane = "attackarcane",
            attackfire = "attackfire",
            attacklightning = "attacklightning",
            attackpoison = "attackpoison",
            avoidtarget = "avoidtarget",
            ballappear = "ballappear",
            blackout = "blackout",
            bossout = "bossout",
            breathsoon = "breathsoon",
            causticsoon = "causticsoon",
            doubleat = "doubleat",
            eleaesoon = "eleaesoon",
            eleaestart = "eleaestart",
            enoughstack = "enoughstack",
            firestomp = "firestomp",
            focusattack = "focusattack",
            frostappear = "frostappear",
            frostsoon = "frostsoon",
            furysoon = "furysoon",
            gofire = "gofire",
            killrageface = "killrageface",
            mutant = "mutant",
            selffight = "selffight",
            shadowae = "shadowae",
            shockrun = "shockrun",
            targetsoon = "targetsoon",
            twilighttime = "twilighttime",
            windblast = "windblast",
            windblastsoon = "windblastsoon",
