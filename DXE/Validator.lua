...
local master_schema = {
	...
	schema = {
        ...
        advanced = {
            opttable,
            schema = {
                silentDefeat = optboolean,
                disableAutoWipe = optboolean,
                preventPostDefeatPull = {
                    optnumber,
                    if_number = {range = {min = 1, max = 60}},
                }
                recordBestTime = optboolean,
            },
        },
		triggers = {
			opttable,
		...
		alerts = {
			...
			hash = {
				each = {
					...
					schema = {
						varname = isstring,
						type = {isstring, inclusion = {"centerpopup","centerpopupnotimer","dropdown","simple","absorb"}},
                        ...
                        warningtext = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext2 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext3 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext4 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext5 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext6 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext7 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext8 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        warningtext9 = {optstringtable, if_table = {series_table = true}, if_string = {replaces = true}},
                        ...
                        enabled = optboolean,
                        remote = optboolean,
                        emphasizewarning = optboolean,
                        emphasize = optboolean,
					},
				},
			},
		},
		...
		announces = {
			...
			hash = {
				each = {
					...
					schema = {
						varname = isstring,
						type = {isstring, inclusion = {"SAY","PARTY","RAID"}},
			...
			each = {
				...
				array = {
					...
					each_pair = {
                        ...
                        closetemptracing = isboolean,
                        addphasemarker = {
                            istable,
                            array = {size = 4},
                            schema = {
                                {isnumberstring, replaces = true},
                                {isnumberstring, replaces = true},
                                {isstring, replaces = true},
                                {isstring, replaces = true},
                            },
                        ...
                        counter = {
                            istable,
                            array_part = {min = 3, max = 6},
                        }
                        removecounter = {
                            isstring
                        }
                        silentdefeat = isboolean,
                        triggerdefeat = isboolean,
						proximitycheck = {
							istable,
							array = {size = 2},
							schema = {
